...
class Ui_masar(object):
    def setupUi(self, masar):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/nsls2-logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.configEventSplitter.setObjectName("configEventSplitter")
        ...
        self.systemCombox.setCursor(QtCore.Qt.SizeVerCursor)
        self.systemCombox.setMouseTracking(True)
        self.systemCombox.setObjectName("systemCombox")
        self.configGridLayout.addWidget(self.systemCombox, 0, 1, 1, 1)
        self.configFilterLabel = QtGui.QLabel(self.layoutWidget)
        self.configFilterLabel.setObjectName("configFilterLabel")
        ...
        self.configFilterLineEdit.setProperty("placeholderText", "")
        self.configFilterLineEdit.setObjectName("configFilterLineEdit")
        ...
        self.fetchConfigButton.setObjectName("fetchConfigButton")
        ...
        self.eventVerticalLayout.setObjectName("eventVerticalLayout")
        self.eventGridLayout = QtGui.QGridLayout()
        self.eventGridLayout.setObjectName("eventGridLayout")
        self.timeRangeCheckBox = QtGui.QCheckBox(self.layoutWidget1)
        self.timeRangeCheckBox.setObjectName("timeRangeCheckBox")
        ...
        self.eventStartDateTime.setObjectName("eventStartDateTime")
        ...
        self.fetchEventButton.setObjectName("fetchEventButton")
        ...
        self.snapshotHorizontalLayout.setObjectName("snapshotHorizontalLayout")
        ...
        self.fetchSnapshotButton.setObjectName("fetchSnapshotButton")
        ...
        self.snapshotTabWidget.setObjectName("snapshotTabWidget")
        ...
        self.currentCommentText.setObjectName("currentCommentText")
        self.commentTabWindowLayout.addWidget(self.currentCommentText)
        self.snapshotTabWidget.addTab(self.commentTab, "")
    ...
    def retranslateUi(self, masar):
        ...
        self.eventTableWidget.setToolTip(QtGui.QApplication.translate("masar", "<html><head/><body><p>eventTable: a list of saved snapshot(s) for the selected config(s)</p><p><span style=\" color:#00ff00;\">DOUBLE CLICK</span> on one row to display <span style=\" color:#00ff00;\">ONE</span> snapshot data </p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
...
"\n"
"    * event table: a list of saved events / snapshots for a particular config; it has Config which is listed in the config table, Description,  Author ...  \n"
"\n"
