...
from PyQt4.QtGui import (QDialog, QGridLayout, QTableWidget, QLineEdit, QPushButton, QBrush, QLabel)
...
class MonSetpoint(QDialog):
    def __init__(self, configFile, parent=None):
        super(MonSetpoint, self).__init__(parent)
        self.configFile = configFile
        self.setWindowTitle('Monitor setpoint v.s. readback')
        ...
        layout.addWidget(self.findLineEdit)#row, col, how-many-rows, col-span
        #=======================================================================
